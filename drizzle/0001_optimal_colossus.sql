...
ALTER TABLE "matches" ALTER COLUMN "status" SET DEFAULT 'Schedule'::text;--> statement-breakpoint
DROP TYPE "public"."match_status";--> statement-breakpoint
CREATE TYPE "public"."match_status" AS ENUM('Scheduled', 'Live', 'Finished');--> statement-breakpoint
ALTER TABLE "matches" ALTER COLUMN "status" SET DEFAULT 'Schedule'::"public"."match_status";--> statement-breakpoint
